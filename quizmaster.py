...
def draw() :
    ...
    screen.draw.filled_rect(answer_box4, "blue")
    ...
    screen.draw.textbox(question[0].strip(), question_box, color = "white", shawdow = (0.5,0.5), scolor = "dim gray")
    index = 1
    screen.draw.textbox(question[index].strip(), answer_box1, color = "black")
    screen.draw.textbox(question[index].strip(), answer_box2, color = "black")
    screen.draw.textbox(question[index].strip(), answer_box3, color = "black")
    screen.draw.textbox(question[index].strip(), answer_box4, color = "black")
    index = index + 1
